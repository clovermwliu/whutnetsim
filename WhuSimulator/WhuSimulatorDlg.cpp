...
BOOL CWhuSimulatorDlg::OnInitDialog()
{
	...
	// TODO: 在此添加额外的初始化代码
	m_tab.InsertItem(0,_T("拓扑生成"));  //添加参数一选项卡
	m_tab.InsertItem(1,_T("运行"));  //添加参数二选项卡

	//关联对话框,并且将IDD_TEST_DIALOG控件设为父窗口
