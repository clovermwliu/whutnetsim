...
#include <QtCore/qobject.h>//#include <qobject.h>
#include <QtGui/qapplication.h>//#include <qapplication.h>
#include <Qt3Support/q3canvas.h>
#include <QtGui/qlcdnumber.h>//#include <qlcdnumber.h>
#include <QtGui/qslider.h>//#include <qslider.h>
#include <QtGui/QVBoxLayout>//#include <qvbox.h>
...
public:
  NNIfLink(Node* n1, Node* n2, InterfaceBasic* is, InterfaceBasic* id,
           Link* ls,Link* ld, Q3CanvasPolygonalItem* item)
...
public:
  ...
  Link*      linkSource;
  Link*      linkDest;
  Q3CanvasPolygonalItem* canvasItem;
};
...
typedef std::vector<Q3CanvasPolygonalItem*> CPItemVec_t;
typedef std::vector<Q3CanvasItem*>          CItemVec_t;
...
//Doc:ClassXRef
class gui_ctrl : public QObject, public Handler {
  Q_OBJECT
public:
  gui_ctrl(bool,QApplication*);
  ~gui_ctrl();
public:
...
private:
  ...
  QLCDNumber*   simTime;
  QTimer*       readyTimer;
  gui_frame*  mw;       // Main window 
  Q3VBox*  box;      // The container for the other windows
...
public:
  static gui_ctrl* qtWin;
};

#else
class QTEvent;
//Doc:ClassXRef
class gui_ctrl : public Handler {
public:
  gui_ctrl();
  ~gui_ctrl();
public:
