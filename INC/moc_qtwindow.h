/****************************************************************************
** gui_ctrl meta object code from reading C++ file 'gui_ctrl.h'
**
...
const char *gui_ctrl::className() const
{
    return "gui_ctrl";
}

QMetaObject *gui_ctrl::metaObj = 0;
static QMetaObjectCleanUp cleanUp_QTWindow( "gui_ctrl", &gui_ctrl::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString gui_ctrl::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "gui_ctrl", s, c, MyApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString gui_ctrl::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "gui_ctrl", s, c, MyApplication::UnicodeUTF8 );
    else
...
QMetaObject* gui_ctrl::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
...
void* gui_ctrl::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "gui_ctrl" ) )
	return this;
...
bool gui_ctrl::qt_invoke( int _id, QUObject* _o )
{
...
bool gui_ctrl::qt_emit( int _id, QUObject* _o )
{
    return QObject::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool gui_ctrl::qt_property( int id, int f, QVariant* v)
{
    return QObject::qt_property( id, f, v);
}

bool gui_ctrl::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
