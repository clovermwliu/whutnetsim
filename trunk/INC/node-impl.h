...
//QT窗口信息
  ...
  virtual QCanvasItem*   Display(QTWindow*) = 0;//确定点显示的形状、大小等，显示位置为点当前的位置
  virtual QCanvasItem*   Display(const QPoint&, QTWindow*) = 0;//确定点显示的形状、大小等，显示位置参数中提供的位置
  ...
  virtual void           Color(const QColor&) = 0;//指定本地结点的颜色
  virtual bool           HasColor() = 0;//检查本地结点是否已经分配颜色
  virtual QColor&        Color() = 0;//返回本地结点的颜色
